  ...
  return (
    <Timeline>
      <Timeline.Item>
        ...
        <Timeline.Content>
          <Timeline.Time>Feb 2024 – Aug 2024 · 6 mos</Timeline.Time>
          <Timeline.Title className="text-white">PT Phincon</Timeline.Title>
          <p className="text-gray-300 text-2sm font-semibold">
            Back End Developer Intern
          </p>
          <Timeline.Body>
            During my internship at PT Phincon, I developed several key
            features, including modules to evaluate admin performance, manage
            employee shifts, generate calling lists, and display interaction
            recordings. These projects improved operational efficiency and data
            accessibility.
          </Timeline.Body>
        </Timeline.Content>
      </Timeline.Item>
      ...
      <Timeline.Item>
        ...
        <Timeline.Content>
          ...
          <Timeline.Body>
            I have created a responsive and attractive interface using React.js
            and Tailwind CSS. In addition, I also integrated PWA technology and
            public APIs into the restaurant information website. I also created
            a RESTful API for the bookshelf application. In addition, I have
            achieved the status as the best student in Dicoding Indonesia.
          </Timeline.Body>
        </Timeline.Content>
      </Timeline.Item>
      <Timeline.Item>
        ...
        <Timeline.Content>
          ...
          <Timeline.Body>
            ...
            experience. Simultaneously, I developed a program module using COBOL
            and BASIC languages, demonstrating proficiency in diverse
